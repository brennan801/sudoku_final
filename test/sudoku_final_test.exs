defmodule SudokuFinalTest do
  use ExUnit.Case
  doctest SudokuFinal

  # test "accepted equals solved" do
  #   solved_board = [
  ...
  #     %Cell{x: 1,y: 1,value: 7}, %Cell{x: 2,y: 1,value: 6}, %Cell{x: 3,y: 1,value: 3}, %Cell{x: 4,y: 1,value: 4}, %Cell{x: 5,y: 1,value: 1}, %Cell{x: 6,y: 1,value: 8}, %Cell{x: 7,y: 1,value: 2}, %Cell{x: 8,y: 1,value: 5}, %Cell{x: 9,y: 1,value: 9},
  #   ]
  #   assert Enum.sort(accepted_board) == Enum.sort(solved_board)
  # end
  ...
  test "Column sum = 45" do
    column = [%Cell{x: 1,y: 9,value: 4},
    %Cell{x: 1,y: 8,value: 6},
    %Cell{x: 1,y: 7,value: 1},
    %Cell{x: 1,y: 6,value: 8},
    %Cell{x: 1,y: 5,value: 3},
    %Cell{x: 1,y: 4,value: 9},
    %Cell{x: 1,y: 3,value: 5},
    %Cell{x: 1,y: 2,value: 2},
    %Cell{x: 1,y: 1,value: 7}]
    sum = Enum.uniq(column.value)
    |>Enum.sum()
    assert sum == 45
  end

  test "Nonent sum = 45" do
    nonent = [%Cell{x: 1,y: 9,value: 4}, %Cell{x: 2,y: 9,value: 3}, %Cell{x: 3,y: 9,value: 5},
    %Cell{x: 1,y: 8,value: 6}, %Cell{x: 2,y: 8,value: 8}, %Cell{x: 3,y: 8,value: 2},
    %Cell{x: 1,y: 7,value: 1}, %Cell{x: 2,y: 7,value: 9}, %Cell{x: 3,y: 7,value: 7}]

    sum = Enum.uniq(nonent.value)
    |>Enum.sum()
    assert sum == 45
  ...
  test "Solved board" do
    ...
    actual_board = Solver.board_solver(start_board)
    assert Enum.sort(accepted_board) == Enum.sort(actual_board)
  end
